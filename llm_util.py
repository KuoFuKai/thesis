...
def interact(llm, rag):
    ...
    with sr.Microphone() as source:
        while True:
            ...
            try:
                user_input = recognizer.recognize_whisper(audio, language="chinese", model="small").lower()
                ...
                while True:
                    audio = recognizer.listen(source)
                    confirmation = recognizer.recognize_whisper(audio, language="chinese", model="small").lower().strip('. ')
                    print(confirmation)
